...
(function (CalculatorHtml) {
    CalculatorHtml.CALCULATE = document.getElementsByClassName('calc__getResult')[0];
    CalculatorHtml.RESULT = document.getElementsByClassName('calc-result')[0];
    CalculatorHtml.ClEARbTN = document.getElementsByClassName('calc__clearBtn')[0];
    CalculatorHtml.CALCNUMBERS = document.getElementsByClassName('calc__numbers')[0];
    CalculatorHtml.CALCOPERATORS = document.getElementsByClassName('calc__operators')[0];
